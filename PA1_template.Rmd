...
For further analysis and creating of plots I loaded the ```dplyr``` package and the ```ggplot2``` package.
...
To demonstrate the impact of imputing missing values, I plotted and overlay of the distribution of both, original data and modified data with imputed values, and added density curves for both.
